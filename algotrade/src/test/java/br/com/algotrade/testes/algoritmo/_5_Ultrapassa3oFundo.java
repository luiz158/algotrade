...
public class _5_Ultrapassa3oFundo {
	@Before 
	public void antes() {
	...
	private void imprimeTudo() {
		...
		case 8:
			...
			break;
		case 9:
			assertEquals("valorCorrente", new BigDecimal(3.8).setScale(2, RoundingMode.HALF_UP), valorCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoTopo", new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), valorDoTopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoFundo", new BigDecimal(3.8).setScale(2, RoundingMode.HALF_UP), valorDoFundo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("diferencaFaT", new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(1.5).setScale(2, RoundingMode.HALF_UP), rangeInicioDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(2.4).setScale(2, RoundingMode.HALF_UP), rangeLimiteDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(4).setScale(2, RoundingMode.HALF_UP), armazenaValorSegundoFundo.setScale(2, RoundingMode.HALF_UP));
		...
		case 10:
			...
			assertEquals("valorDoTopo", new BigDecimal(5.5).setScale(2, RoundingMode.HALF_UP), valorDoTopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoFundo", new BigDecimal(3.8).setScale(2, RoundingMode.HALF_UP), valorDoFundo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("diferencaDeFundoATopo", new BigDecimal(1.7).setScale(2, RoundingMode.HALF_UP), diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(1.5).setScale(2, RoundingMode.HALF_UP), rangeInicioDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(2.4).setScale(2, RoundingMode.HALF_UP), rangeLimiteDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(4).setScale(2, RoundingMode.HALF_UP), armazenaValorSegundoFundo.setScale(2, RoundingMode.HALF_UP));
		...
		case 11:
			...
			assertEquals("valorDoTopo", new BigDecimal(6).setScale(2, RoundingMode.HALF_UP), valorDoTopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoFundo", new BigDecimal(3.8).setScale(2, RoundingMode.HALF_UP), valorDoFundo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("diferencaDeFundoATopo", new BigDecimal(2.2).setScale(2, RoundingMode.HALF_UP), diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(1.5).setScale(2, RoundingMode.HALF_UP), rangeInicioDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(2.4).setScale(2, RoundingMode.HALF_UP), rangeLimiteDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(4).setScale(2, RoundingMode.HALF_UP), armazenaValorSegundoFundo.setScale(2, RoundingMode.HALF_UP));
