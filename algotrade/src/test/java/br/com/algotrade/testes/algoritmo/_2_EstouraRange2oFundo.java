...
public class _2_EstouraRange2oFundo {
	@Before 
	public void antes() {
	...
	private void imprimeTudo() {
		...
		System.out.println("valorCorrente: " + valorCorrente.setScale(2, RoundingMode.HALF_UP));
		System.out.println("---------------------------------");
		System.out.println("valorDoTopo: " + valorDoTopo.setScale(2, RoundingMode.HALF_UP));
		System.out.println("valorDoFundo: " + valorDoFundo.setScale(2, RoundingMode.HALF_UP));
		System.out.println("diferencaDeFundoATopo: " + diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
		System.out.println("");
		System.out.println("correcaoCorrente: " + correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
		System.out.println("rangeInicioDaCorrecao: " + rangeInicioDaCorrecao.setScale(2, RoundingMode.HALF_UP));
		System.out.println("rangeLimiteDaCorrecao: " + rangeLimiteDaCorrecao.setScale(2, RoundingMode.HALF_UP));
		System.out.println("");
		...
		case 4:
			...
			break;
		case 5:
			assertEquals("valorCorrente", new BigDecimal(2.2).setScale(2, RoundingMode.HALF_UP), valorCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoTopo", new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), valorDoTopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoFundo", new BigDecimal(2.2).setScale(2, RoundingMode.HALF_UP), valorDoFundo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("diferencaDeFundoATopo", new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
		...
		case 6:
			assertEquals("valorCorrente", new BigDecimal(4).setScale(2, RoundingMode.HALF_UP), valorCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoTopo", new BigDecimal(4).setScale(2, RoundingMode.HALF_UP), valorDoTopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("valorDoFundo", new BigDecimal(2.2).setScale(2, RoundingMode.HALF_UP), valorDoFundo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("diferencaDeFundoATopo", new BigDecimal(1.8).setScale(2, RoundingMode.HALF_UP), diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(2).setScale(2, RoundingMode.HALF_UP), rangeInicioDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(3.2).setScale(2, RoundingMode.HALF_UP), rangeLimiteDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), armazenaValorSegundoFundo.setScale(2, RoundingMode.HALF_UP));
		...
		case 7:
			...
			assertEquals("valorDoFundo", new BigDecimal(2.2).setScale(2, RoundingMode.HALF_UP), valorDoFundo.setScale(2, RoundingMode.HALF_UP));
			assertEquals("diferencaDeFundoATopo", new BigDecimal(4.8).setScale(2, RoundingMode.HALF_UP), diferencaDeFundoATopo.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), correcaoCorrente.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(2.4).setScale(2, RoundingMode.HALF_UP), rangeInicioDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(3.84).setScale(2, RoundingMode.HALF_UP), rangeLimiteDaCorrecao.setScale(2, RoundingMode.HALF_UP));
			assertEquals(new BigDecimal(0).setScale(2, RoundingMode.HALF_UP), armazenaValorSegundoFundo.setScale(2, RoundingMode.HALF_UP));
			assertTrue(formadoTopoRelevante);
			assertFalse(formouSegundoFundo);
			assertFalse(formadoSegundoTopo);
